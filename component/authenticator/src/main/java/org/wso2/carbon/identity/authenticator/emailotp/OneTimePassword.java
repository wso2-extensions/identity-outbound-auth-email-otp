...
public class OneTimePassword {
    ...
    public static byte[] hmacShaGenerate(byte[] keyBytes, byte[] text)
        ...
        Mac hmacSha;
        try {
            hmacSha = Mac.getInstance(EmailOTPAuthenticatorConstants.ALGORITHM_HMAC);
        } catch (NoSuchAlgorithmException nsa) {
            hmacSha = Mac.getInstance(EmailOTPAuthenticatorConstants.ALGORITHM_HMAC_SHA);
        }
     ...
     * @param movingFactor     The counter, or other value that changes on a per use basis.
